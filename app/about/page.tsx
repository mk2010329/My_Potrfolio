        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div
            className="
              ...
              bg-[length:200%_200%] animate-gradient-border
              shadow-2xl
            "
          >
            {/* Main Content Card */}
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 relative overflow-hidden"
            >
              {/* Floating Icons */}
              ...
              {/* === Content Grid (keep your existing cards) === */}
